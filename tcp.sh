...
installbbrplus(){
	...
	if [[ "${release}" == "centos" ]]; then
		...
		wget -N --no-check-certificate https://github.com/November-raining/4.14.129plus/releases/download/1.0/linux-headers-4.14.129-bbrplus.deb
		wget -N --no-check-certificate https://github.com/November-raining/4.14.129plus/releases/download/1.0/linux-image-4.14.129-bbrplus.deb
		dpkg -i linux-headers-${kernel_version}.deb
		dpkg -i linux-image-${kernel_version}.deb
		cd .. && rm -rf bbrplus
	fi
